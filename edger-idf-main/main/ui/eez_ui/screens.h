...
typedef struct _objects_t {
    ...
    lv_obj_t *settings_box;
    lv_obj_t *settings_box__name_10;
    lv_obj_t *settings_box__spinbox_edging_max_arousal;
    lv_obj_t *settings_box__name_11;
    lv_obj_t *settings_box__spinbox_cooldown_max_arousal;
    lv_obj_t *settings_box__name_16;
    lv_obj_t *settings_box__spinbox_cooldown_time;
    lv_obj_t *settings_box__name_14;
    lv_obj_t *settings_box__spinbox_motor_min_percent;
    lv_obj_t *settings_box__name_15;
    lv_obj_t *settings_box__spinbox_motor_max_percent;
    lv_obj_t *settings_box__spinbox_motor_ramp_time;
    lv_obj_t *settings_box__name_12;
    lv_obj_t *settings_box__spinbox_motor_plateau_time;
    lv_obj_t *settings_box__name_13;
    lv_obj_t *settings_box__spinbox_motor_break_ratio_percent;
} objects_t;
