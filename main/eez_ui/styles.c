...
void init_style_style_spinbox_SELECTED_DEFAULT(lv_style_t *style) {
...
lv_style_t *get_style_style_spinbox_SELECTED_DEFAULT() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_spinbox_SELECTED_DEFAULT(style);
    }
    return style;
};
...
void init_style_style_spinbox_CURSOR_FOCUSED(lv_style_t *style) {
    lv_style_set_bg_color(style, lv_color_hex(theme_colors[active_theme_index][0]));
    lv_style_set_text_color(style, lv_color_hex(theme_colors[active_theme_index][1]));
};
...
lv_style_t *get_style_style_spinbox_CURSOR_FOCUSED() {
    ...
    if (!style) {
        style = lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_style_spinbox_CURSOR_FOCUSED(style);
    }
    return style;
};
...
void add_style_style_spinbox(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_style_spinbox_SELECTED_DEFAULT(), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_style_spinbox_CURSOR_DEFAULT(), LV_PART_CURSOR | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_style_spinbox_CURSOR_FOCUSED(), LV_PART_CURSOR | LV_STATE_FOCUSED);
...
void remove_style_style_spinbox(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_style_spinbox_SELECTED_DEFAULT(), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_style_spinbox_CURSOR_DEFAULT(), LV_PART_CURSOR | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_style_spinbox_CURSOR_FOCUSED(), LV_PART_CURSOR | LV_STATE_FOCUSED);
